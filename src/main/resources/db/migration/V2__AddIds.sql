...
ALTER TABLE employee_position ADD position_id int4 NOT NULL  GENERATED ALWAYS AS IDENTITY;
ALTER TABLE employee_position ADD CONSTRAINT position_pk PRIMARY KEY (position_id);
